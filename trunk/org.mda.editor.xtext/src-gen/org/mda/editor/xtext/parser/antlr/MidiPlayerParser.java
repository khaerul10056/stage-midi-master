...
public class MidiPlayerParser extends org.eclipse.xtext.parser.antlr.AbstractAntlrParser {
	...
	protected IParseResult parse(String ruleName, CharStream in) {
		...
		org.mda.editor.xtext.parser.antlr.internal.InternalMidiPlayerParser parser = createParser(tokenStream);
	...
	protected org.mda.editor.xtext.parser.antlr.internal.InternalMidiPlayerParser createParser(XtextTokenStream stream) {
		return new org.mda.editor.xtext.parser.antlr.internal.InternalMidiPlayerParser(stream, getElementFactory(), getGrammarAccess());
	}
