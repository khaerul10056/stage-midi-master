...
public class MidiFileSlideCalculatorTest {
  ...
  public void createLines () {
    ...
    assertEquals ("Alle Schöpfung staunt und preist, betet an in Wahrheit und in Geist, ", calculatePart.getText(0));
  ...
  public void zoom () {
    ...
    for (SlideItem nextFull : slideFullScreen.getItems()) {
      ...
      like ("Font of " + nextFull.getText(), nextFull.getFont().getFontData() [0].getHeight(), nextHalf.getFont().getFontData() [0].getHeight() * 2);
    }
